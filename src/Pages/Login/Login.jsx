    ...
    return (
        <>
            <div className="area">
              ...
              <NavLink className="arrowIcon" to="/SignUp" 
              >
                                                            ...
                                                            <div className="col-12">
                                                                <div className="mb-5">
                                                                    <div className="text-center mb-4">
                                                                        <h2>تسجيل دخول</h2>
                                                                        <a href="#!">
                                                                            <img src="./RegistrationImages/login.svg" alt="login Logo" width={90} height={57} />
                                                                        </a>
                                                                    </div>
                                                                    {/* Welcome back you've been missed! */}
                                                                    <h6 className="text-center">أهلاً بعودتك</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="row">
                                                        ...
                                                        <form action="#!">
                                                            <div className="row gy-3 overflow-hidden">
                                                                ...
                                                                <div className="col-12">
                                                                    <div className="form-floating mb-2 rtl">
                                                                        <input 
                                                                             className="form-control w-100" name="password" 
...
/>
                                                                ...
                                                                <div className="col-12">
                                                                    <div className="d-grid">
                                                                        <button className="btn btn-dark btn-lg submitBtn" type="submit">تسجيل دخول</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                                        <div className="row">
                                                            <div className="col-12 mt-2">
                                                                <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center mt-2">
                                                                    <NavLink to="/SignUp" className="link-secondary link">تريد التسجيل؟</NavLink>
                                                                    <NavLink to="/SendCodeForForgetPassword" className="link-secondary link">نسيت كلمة المرور؟</NavLink>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
